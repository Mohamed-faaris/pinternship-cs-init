// Source: https://sudarshansudarshan.github.io/pinternship/case-studies/01-introduction-to-typescript/
...
The challenge: How do you choose a programming language that supports large-scale development, helps prevent bugs, and offers excellent tools for building everything from web apps to games and server software?
...
TypeScript is a typed, object-oriented programming language that supports classes, interfaces, and static typing.It is designed for building large, maintainable applications and helps developers write code that is reliable and easy to understand.
