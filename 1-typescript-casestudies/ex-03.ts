// Source: https://sudarshansudarshan.github.io/pinternship/case-studies/03-variables-in-typescript/
...
The challenge: How do you declare, use, and manage variables in TypeScript so your code is robust, readable, and error-free?
...
• Write a function called `weatherReport` that takes `city`, `temperature`, and `isRaining` as parameters and prints a message like: "In <city>, it is <temperature>°C. Is it raining? <true/false>"
...
1. Declare neither value nor type:
...
TypeScript enforces strong typing.If you try to assign a value of the wrong type, you get a compilation error:
...
- [←](https://sudarshansudarshan.github.io/pinternship/case-studies/02-basic-syntax-in-typescript/)
